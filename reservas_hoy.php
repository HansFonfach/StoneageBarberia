...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-item nav-link text" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Jesus</a>
    <a class="nav-item nav-link text" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Jesse</a>
  </div>
</nav>
  ...
  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <h2 class="card-header text-center">Reservas Hoy Alejandro</h2>
                            <br>
...
$today = date("Y-m-d");
      ...
      WHERE ID_Barbero = 1 AND Fecha = '".$today."'
  ...
  <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <h2 class="card-header text-center">Reservas Hoy Jesus</h2>
                            <br>
                             <input type="text " class="form-control container text-center" style="width:20%" id="search" placeholder="Buscar">
...
$today = date("Y-m-d");
      ...
      INNER JOIN servicios ON reservas.Servicio = servicios.ID_Servicio
      INNER JOIN horarios ON reservas.ID_Horario = horarios.ID_Horario
      WHERE ID_Barbero = 2  AND Fecha = '".$today."'
      ORDER BY Fecha, reservas.ID_Horario ASC";
  ...
  <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <h2 class="card-header text-center">Reservas Hoy Jesse</h2>
                            <br>
                             <input type="text " class="form-control container text-center" style="width:20%" id="search" placeholder="Buscar">
...
$today = date("Y-m-d");
      ...
      INNER JOIN servicios ON reservas.Servicio = servicios.ID_Servicio
      INNER JOIN horarios ON reservas.ID_Horario = horarios.ID_Horario
      WHERE ID_Barbero = 3  AND Fecha = '".$today."'
      ORDER BY Fecha, reservas.ID_Horario ASC";
