...
<h1 class="text-white text-center container"> </h1>
   ...
   $sql="SELECT usuarios.Rut, usuarios.Nombre, usuarios.Apellido, usuarios.Telefono, barberos.Nombre AS Barbero, servicios.Nombre AS Servicio, horarios.Horas, reservas.Fecha
FROM usuarios
...
WHERE usuarios.Rut ='".$_SESSION['Rut']."' ORDER BY Fecha DESC";
            ...
            ?>
              ...
              ?>
                                        <tbody>
                                            <tr>
                                                <td  class="mostrar"> <img  width="30" heigth="30"src="images/logo.png"><?php if(isset($datos['Barbero'])){echo $datos['Barbero'];} ?>&nbsp;</td>
